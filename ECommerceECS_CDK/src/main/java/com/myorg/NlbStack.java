...
public class NlbStack extends Stack {
    ...
    public NlbStack(final Construct scope, final String id, final StackProps props,
        ...
        networkLoadBalancer = new NetworkLoadBalancer(this, "Nlb",
        ...
        vpcLink = new VpcLink(this, "VpcLink",
                VpcLinkProps.builder()
                        .targets(Collections.singletonList(networkLoadBalancer))
                        .build());

        applicationLoadBalancer = new ApplicationLoadBalancer(this, "Alb",
